 ...
 * Show admin notice
 *
 * @package TutorLMSGotipathIntegration\Notice
 * @since v1.0.0
 */

namespace Tutor\GotipathIntegration\AdminNotice;

use TutorLMSGotipathIntegration;
...
class AdminNotice {
	...
	public static function is_tutor_core_has_req_version(): bool {
		$meta_data = TutorLMSGotipathIntegration::meta_data();
