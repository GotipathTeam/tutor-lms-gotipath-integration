 ...
 *
 * @since v1.0.0
 * @package TutorLMSGotipathIntegration\Views
 */
...
$action_btn  = '';
$plugin_data = TutorLMSGotipathIntegration::meta_data();
...
<div class="notice notice-error tbi-install-notice">
	<div class="tbi-install-notice-inner" style="display:flex; gap: 20px; padding: 10px 0;">
		<div class="tbi-install-notice-icon">
			<img src="<?php echo esc_url( $plugin_data['assets'] . 'images/tutor-logo.jpg' ); ?>" alt="Tutor LMS Gotipath Integration">
		</div>
		<div class="tbi-notice-content-area" style="display: flex; flex-direction: column; gap: 10px;">
			<div class="tbi-install-notice-content">
				<h2>
					<?php esc_html_e( 'Thanks for using Tutor LMS Gotipath Integration', 'tutor-lms-gotipath-integration' ); ?>
				</h2>
				<p>
					<?php
						$text  = _x( 'To use Tutor LMS Gotipath Integration, you must have Tutor LMS ', 'Tutor LMS Require version', 'tutor-lms-gotipath-integration' );
						$text .= esc_html( 'v' . $plugin_data['tutor_req_ver'] );
						$text .= _x( ' installed & activated.', 'Tutor LMS Require version', 'tutor-lms-gotipath-integration' );
						echo esc_html( $text );
					?>
				</p>
				<a href="https://wordpress.org/plugins/tutor/" style="margin-right: 20px;">
					<?php esc_html_e( 'Free install and activate', 'tutor-lms-gotipath-integration' ); ?>
				</a>
				<a href="https://www.themeum.com/product/tutor-lms/" target="_blank">
					<?php esc_html_e( 'Learn more about Tutor LMS', 'tutor-lms-gotipath-integration' ); ?>
				</a>
			</div>
		</div>
	</div>
